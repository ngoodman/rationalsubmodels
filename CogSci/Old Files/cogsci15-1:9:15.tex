...
%One of the most impressive features of the human mind is the extent to which it can sift through a vast knowledge base and pick out those aspects that promise to be helpful in deciding what to do. 
%Understanding how  commonsense reasoning works, and what computations underly it, has been the central aspiration of artificial intelligence, and a central topic of cognitive psychology. 
...
%  \node (s0) at (.0,1.25) [circle,draw=black,fill=Apricot] {$A$};
  
%  \node (s2) at (0,0) [circle,draw=black,fill=gray] {$B$};
